...
public class Solution {
    public class TableInterfaceWrapper implements ATableInterface{
       private ATableInterface HeaderText;
           // private String HeaderText;
        public TableInterfaceWrapper(ATableInterface original){
            this.HeaderText = original;
        }

        @Override
        public void setModel(List rows) {
            System.out.println(rows.size());
            HeaderText.setModel(rows);
        }

        @Override
        public String getHeaderText() {
            return HeaderText.getHeaderText().toUpperCase() ;
        }

        @Override
        public void setHeaderText(String newHeaderText) {
            HeaderText.setHeaderText(newHeaderText);
        }
    }
