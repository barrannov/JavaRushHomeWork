...
public class Solution {
    ...
    public static final class Constants{
        static final String SERVERNOTACCESSIBLEEXCEPTION  = "Server is not accessible for now.";
        static final String UNAUTHORIZEDUSEREXCEPTION  = "User is not authorized.";
        static final String BANNEDUSEREXCEPTION  = "User is banned.";
        static final String RESTRICTIONEXCEPTION  = "Access is denied.";
